...
const Navbar = () => {
  ...
  return (
    <div className="w-full relative">
      <div
        className={`md:hidden  ds:block ${
          togglenav
            ? "-translate-x-[0rem] h-screen fixed top-0 smooth"
            : "smooth fixed top-0 -translate-x-[150rem]"
        }`}
      >
        <ResponsiveNavbar />
      </div>
      ...
      <div className="w-full mx-auto max-w-[82%] p-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              className="flex mx-1 md:hidden items-center justify-center w-auto p-2 rounded-2 bg-primay-blue text-white"
              onClick={toggle}
            >
              <Menu size={16} />
            </button>
