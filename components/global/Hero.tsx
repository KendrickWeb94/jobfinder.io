      ...
      <div className="mx-auto w-full max-w-[82%] ">
        <div className="flex py-12 ds:flex-wrap lg:flex-nowrap items-center ds:justify-center lg:justify-between gap-6">
          <div className="space-y-5 ds:text-center lg:text-left">
            <h1 className="ds:text-4xl text-balance text-gray-800 md:text-3xl lg:text-5xl lg:leading-[3.5rem] font-medium ">
            ...
            <div className=" max-w-lg rounded-2 border-[0.5px] flex flex-wrap md:items-center md:justify-center gap-4 md:gap-2 border-gray-400/45 h-auto p-3 bg-white">
